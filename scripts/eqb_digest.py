    ...
    def _generate_ai_insights(self, analysis: Dict) -> Optional[str]:
        ...
        try:
            ...
            prompt_parts.extend([
                ...
                "=" * 70,
                "",
                "Write a policy briefing in these sections:",
                "",
                "SECTION 1 - OVERVIEW (2-3 sentences):",
                "Lead with the single most interesting or consequential thing in the monitor.",
                "Then briefly state what else is in there. No throat-clearing. No 'deserves scrutiny'.",
                "Start with a concrete fact or comparison that makes someone want to keep reading.",
                "",
                "SECTION 2 - PROJECT ANALYSIS (300-500 words):",
                ...
                "   - CONTEXT: How does this compare to similar projects? Is this big or small for its type?",
                "",
                ...
                "   - Use **bold** for the single most important number or fact in each project",
                "   - Use short paragraphs (2-4 sentences max). White space is your friend.",
                "   - Start each project discussion with the project name in **bold**",
                "   - Put the most surprising or important finding first in each paragraph",
                "",
                ...
                "Format: **Project Name (Location):** One punchy sentence with the key takeaway.",
                "",
                ...
                "=" * 70,
                "",
                "Think: a sharp policy staffer briefing their boss before a meeting.",
                "Informed, direct, and readable. Not dry, not jokey, but with enough",
                "personality that someone actually wants to read this over coffee.",
                "",
                "VOICE AND TONE:",
                "   - Lead with what matters. Put the most important thing first, always.",
                "   - Be direct and confident. Say what you think is going on.",
                "   - Use comparisons to make numbers land ('enough water for 10,000 homes').",
                "   - Short paragraphs. Vary sentence length. One-sentence paragraphs are fine.",
                "   - Name the stakes plainly. Don't say 'raises concerns', say what the concern IS.",
                "   - If something is absurd or contradictory, just state both facts and let the",
                "     reader connect the dots. That's funnier than any joke.",
                "   - Use specifics over generalities. '800 feet from a state prairie' beats 'near sensitive habitat'.",
                "",
                "FORMATTING THAT AIDS MEMORY:",
                "   - **Bold** the single most striking fact per project",
                "   - Use numbers. People remember '750,000 tons' better than 'a large amount'",
                "   - Use comparisons when available ('4x the water usage of a typical industrial site')",
                "   - If an agency said something pointed, quote them directly. That sticks.",
                "",
                ...
                "     scrutiny, notable, noteworthy, remarkable, extraordinary, significant",
                ...
                "   - Fluffy intros that 'set up' the analysis. Just start.",
                "",
                "Good example: '**750,000 tons of aggregate annually**, 160 truck trips",
                "per day, 800 feet from Lost Valley Prairie (a state Scientific and Natural",
                "Area). DNR flagged blasting impacts on rare species. The township approved",
                "it anyway.'",
                "",
                ...
                "",
                "Write like you're explaining things to a smart colleague who has five minutes.",
                "Be direct. Be specific. Make the facts land."
            ])
    ...
    def _generate_batched_insights(self, analysis: Dict, projects_with_docs: List[Dict],
        ...
        try:
            ...
            synthesis_prompt.extend([
                ...
                "SECTION 1 - OVERVIEW (2-3 sentences):",
                "Lead with the single most interesting or consequential thing in the monitor.",
                "Then briefly state what else is in there. Start with a concrete fact.",
                "",
                "SECTION 2 - PROJECT ANALYSIS (500-700 words):",
                "Synthesize all the projects into a coherent narrative. Group related projects.",
                "Highlight the most important developments. Note any data centers (confirmed or suspected).",
                "Use **bold** for key numbers and project names. Short paragraphs. Lead with what matters.",
                "Use comparisons to make numbers land when possible.",
                "",
                "ACCURACY REQUIREMENTS:",
                ...
                "",
                "WRITING STYLE: Direct, informed, readable. Like a sharp staffer briefing their boss.",
                "Use **bold** for key facts. Short paragraphs. No em dashes.",
                "Avoid: 'delve', 'tapestry', 'vibrant', 'landscape', sarcastic asides, 'significant'.",
                "Use comparisons to make numbers stick. Let the facts land."
            ])
